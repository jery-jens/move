    ...
    return (
        <section className="relative border-b-blue border-b-[2px] border-solid border-opacity-20 mb-16 overflow-hidden">
            <div className="container mx-auto px-7 lg:pt-80 pt-52">
                <div className="lg:pb-40 lg:pl-[600px] pb-20 flex flex-col lg:items-start items-center w-full">
                    ...
                    <div className="lg:w-[650px] w-[450px] h-full lg:flex hidden absolute left-0 top-0">
                        <div className="absolute left-0 top-0 w-full h-full bg-blue-gradient z-10 bg-opacity-50"></div>
