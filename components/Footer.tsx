...
export default function Footer({Address, Phone, Email, Facebook, Instagram, Openinghours, Links}:IFooter) {
    return (
        <footer className="border-t border-t-blue border-opacity-10 border-solid">
            <div className="mx-auto container px-7 py-16 flex lg:flex-row flex-col gap-14">
                <div className="w-full">
                    <h4 className="font-poppins font-semibold uppercase tracking-wider lg:text-xl text-base mb-4">Contact</h4>
                ...
                <div className="w-full">
                    <h4 className="font-poppins font-semibold uppercase tracking-wider lg:text-xl text-base  mb-4">Openingsuren</h4>
                ...
                <div className="w-full">
                    <h4 className="font-poppins font-semibold uppercase tracking-wider lg:text-xl text-base mb-4">Navigatie</h4>

                    <div className="flex flex-col gap-1 items-start">
                        {
                            Links && Links.map((link:IFooterLink, i:number) => {
                                return <Link key={i} className="text-blue underline font-openSans lg:text-xl text-base" href={link.Link} target={link.OpenInNewTab ? "_blank" : "_self"}>{link.Label}</Link>
                            })
                        }
                    </div>
                </div>
            ...
            <div className="bg-blue py-5">
                <div className="mx-auto container px-7 flex justify-between items-center">
                    <span className="font-openSans lg:text-sm text-xs text-white">
